...
public class Protocol {
	...
	public static final int NOT_AVAILABLE_CODE = 503;
	public static final String NOT_AVAILABLE_TEXT = "Service Not Available";
	...
	public static final String IF_LAST_MODIFIED = "If-Modified-Since";
	...
	public static final String SERVER_INFO = "Best Web Server(BWS)/1.0.0";
	public static final String PROVIDER = "Provider";
	public static final String AUTHOR = "Luke Kennedy and Andrew Hopkins";
